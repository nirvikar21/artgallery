...
class Sculptures extends React.Component {
   ...
   componentDidMount(){
      this.props.getData('sculptures');
      //console.log("=====Stateprops",this.props);
   } 
   render(props) {
      let {sculpturesdata}= this.props;
      //console.log("sculpturesdata==123",this.props);
      let sculptures;
      if(sculpturesdata.payload !==undefined){
         sculptures=sculpturesdata.payload.data;
      }     
      return (
         <div> 
            <section className="Art">
               <div className="container">
                  <h2 className="headings-all">Sculptures</h2>   
                  <div className="border"></div>
                     <div className="row">
                     {(typeof sculptures !=='undefined')?sculptures.map(item => (
...
const mapStateToProps =(state)=>{
   //alert("mapStateToProps");
	return{
        sculpturesdata:  state.sculptures?state.sculptures:[]
	}
}
...
const mapDispatchToProps =(dispatch)=>{
 ...
 export default connect(mapStateToProps,mapDispatchToProps) (Sculptures);