...
class Painting extends React.Component {
   ...
   componentDidMount(){
      this.props.getData('painting')
      //console.log("=====Stateprops",this.props);
   } 
   render(props) {

      let {paintingdata}= this.props;
      //console.log("painting==",paintingdata.payload);
      let paints;
      if(paintingdata.payload !==undefined){
         paints=paintingdata.payload.data;
      }     
      return (
         ...
         <div> 
            <section className="Art">
               <div className="container">
                  <h2 className="headings-all">Paintings</h2>   
                  <div className="border"></div>
                     <div className="row">
                     {(typeof paints !=='undefined')?paints.map(item => (
...
const mapStateToProps =(state)=>{
	...
	return{
      ...
      paintingdata:  state.painting?state.painting:[]
	}
}
